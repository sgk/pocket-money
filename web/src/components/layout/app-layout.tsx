      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-full flex-1 min-h-0 min-[1200px]:flex-row">
          ...
          <div className="flex flex-1 min-h-0 flex-col">
            <main className="relative z-0 flex-1 min-h-0 overflow-x-hidden max-[900px]:overflow-x-visible overflow-y-auto max-[900px]:px-0 min-[901px]:px-4 pb-0 pt-0 min-[1200px]:px-6 min-[1200px]:pb-0 min-[1200px]:pt-0">
